"""Pokemon Gold: everything but the smoke test.
...
This is the Virtual Console release rather than the 1999 cartridge, and it is the only Gold in
this dataset - see :mod:`vc` for why. Everything it shares with Silver is in
...
SPRITE_SET = "generation-ii/gold/transparent"
...
ONLY_ON_SILVER: dict[str, str | None] = {
    "vulpix": None,
    "meowth": None,
    "ledyba": None,
    "delibird": None,
...
UNOBTAINABLE: dict[str, str] = {
    ...
    **{species: johto.gbc_only_on("Silver", event) for species, event in ONLY_ON_SILVER.items()},
}
...
def register(registry: GameRegistry) -> None:
    registry.register(GAME_ID, build, edges(), box_art="Gold EN boxart.png")
