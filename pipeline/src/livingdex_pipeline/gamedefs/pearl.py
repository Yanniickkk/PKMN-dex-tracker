"""Pokemon Pearl: everything but the smoke test.
...
Everything it shares with Diamond is in :mod:`sinnoh`, the dex included - the two of them number
...
UNOBTAINABLE: dict[str, str] = {
    ...
    "cranidos": sinnoh.fossil_only_on("Diamond", "Skull Fossil", CRANIDOS_EVENT),
...
def register(registry: GameRegistry) -> None:
    registry.register(GAME_ID, build, edges(), box_art="Pearl EN boxart.jpg")
